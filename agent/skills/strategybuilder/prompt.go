...
- Globals: MarketCondition string "1".."11"; NowPrice; NowSymbolPercentChange/Close/Open/Low/High; SystemStartTime; NowTime; IsAsc; IsDesc; KdjSimple.
