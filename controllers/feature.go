...
func (ctrl *FeatureController) Get() {
	...
	result, err := (symbolservice.Service{}).List(ctrl.Ctx.Request.Context(), symbolservice.ListOptions{
		Sort: ctrl.GetString("sort"), SymbolType: ctrl.GetString("symbol_type"), Symbol: ctrl.GetString("symbol"),
		Enable: ctrl.GetString("enable"), MarginType: ctrl.GetString("margin_type"), Pin: ctrl.GetString("pin"),
	...
	ctrl.Ctx.Resp(map[string]interface{}{
		"code": 200,
		"data": map[string]interface{}{"total": result.Total, "list": result.List},
		"msg":  "success",
	})
}
